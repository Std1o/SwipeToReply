...
public class SwipeController extends ItemTouchHelper.Callback {
    ...
    public SwipeController(Activity context, ISwipeControllerActions swipeControllerActions){
        mContext = context;
    ...
    public SwipeController(Activity context, ISwipeControllerActions swipeControllerActions, int replyIcon, int replyIconBackground, int backgroundColor){
        mContext = context;
        mSwipeControllerActions = swipeControllerActions;
    ...
    public void onChildDraw(@NonNull Canvas c, @NonNull RecyclerView recyclerView, @NonNull RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive){
        ...
        if (mView.getTranslationX() > convertToDp(-100) || dX > mDx ){
    ...
    private void drawReplyButton(Canvas canvas){
        ...
        int x;
        float y;
        x = maxX + (int) mView.getTranslationX() /2;
